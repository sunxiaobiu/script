...
public class TypeStateMisusesCompareCrySl {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (String fileName : logFileNames) {
            ...
            while (it.hasNext()) {
                ...
                if(currentLine.contains("======Misuse=======ICC") && (misuseStr.contains("Cipher") || misuseStr.contains("crypto") || misuseStr.contains("security") )){
                    misuseICCNum ++;
                ...
                if(currentLine.contains("======Misuse=======Component") && (misuseStr.contains("Cipher") || misuseStr.contains("crypto")|| misuseStr.contains("security") )){
                    misuseComponentNum ++;
                    //existMisuse.add(misuseStr.toString());
                    misuseAPIs.addAll(apis);
                    for(String api : apis){
                ...
                if(currentLine.contains("======Misuse=======Callback") && (misuseStr.contains("Cipher") || misuseStr.contains("crypto")|| misuseStr.contains("security") )){
                    misuseCallbackNum ++;
                    //existMisuse.add(misuseStr.toString());
                    misuseAPIs.addAll(apis);
                    for(String api : apis){
                ...
                if(currentLine.contains("======Misuse=======method") && (misuseStr.contains("Cipher") || misuseStr.contains("crypto")|| misuseStr.contains("security") )){
                    misuseMethodNum ++;
                    //existMisuse.add(misuseStr.toString());
                    misuseAPIs.addAll(apis);
                    for(String api : apis){
